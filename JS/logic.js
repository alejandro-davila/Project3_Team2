    ...
    d3.json(url).then(function(data){
       ...
       // let ColorScale=d3.scaleSequential(d3.interpolateRdYlGn).domain([90,minimum]);
        ...
        for (let i = 0; i < stations.length; i++) {
          ...
          let address = stations[i].street_address
          let address2 = stations[i].city
          let address3 = stations[i].state  
         ...
         .bindPopup("<h1>" + properties+ "<h1><h2>"+address+" "+address2+" "+address3+"</h2><h3>Fuel Type: " + fueltype + "</h3>");
